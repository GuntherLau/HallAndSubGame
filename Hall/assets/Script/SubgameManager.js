const SubgameManager = {
    ...
    _getfiles: function(name, type, downloadCallback, finishCallback) {
        ...
        /// 替换该地址
        var UIRLFILE = "http://192.168.31.111:8080/" + name;
    ...
    _checkCb: function(event) {
        ...
        switch (event.getEventCode()) {
            ...
            case jsb.EventAssetsManager.ERROR_DOWNLOAD_MANIFEST:
                ...
                failed = true;
                console.log("event err:"+ JSON.stringify(event));
                break;
            case jsb.EventAssetsManager.ERROR_PARSE_MANIFEST:
                /*2 解析文件错误*/
    ...
    enterSubgame: function(name) {
        ...
        console.log("enterSubgame:"+ name);
        console.log("jsb.fileUtils.isFileExist:"+ jsb.fileUtils.isFileExist(this._storagePath[name] + '/src/main.js'));
        console.log("jsb.fileUtils.getFileSize:"+ jsb.fileUtils.getFileSize(this._storagePath[name] + '/src/main.js'));
